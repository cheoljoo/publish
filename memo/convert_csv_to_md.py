...
if __name__ == "__main__":
    ...
    parser.add_argument("tag_file", nargs='?', default="tag.json", help="tag json file")
    parser.add_argument("header_file", nargs='?', default="header.txt", help="header txt in front of output_file")
    ...
    log(f"Tag file: {tag_file}")
    log(f"Header file: {header_file}")
