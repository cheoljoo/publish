# - description : education 관련 csv내용을 markdown으로 변환하는 프로그램
# - tag : education , python , run , csv , markdown , convert
import os
import time
import sys
import csv
...
#input_file = os.path.join(workspace_folder, "memo/education",args.input_file)
#output_file = os.path.join(workspace_folder,"memo/education", args.output_file)
    ...
    with open(input_file, "r", encoding="utf-8") as file:
        ...
        with open(output_file, "w", encoding="utf-8") as output:
            output.write('- description : education review : 교육 받은 내용 정리\n')
            output.write('- tag : education , list\n')
            output.write('\n<H1>Education Lists</H1>\n\n')
