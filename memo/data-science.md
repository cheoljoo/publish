- description : data science에 대해서 추천 책 / 글들을 모아둔 페이지를 그대로 copy해둔 것이다. origin을 참조하기 바란다.
- tag : DE , data , engineer , data-science , recommendation ,
- date : 2025-02-01

origin : https://github.com/DataExpert-io/data-engineer-handbook
...
### 3.2.1. Great [list of over 25 books](books.md)
...
### 3.2.2. Great [list of over 10 communities to join](communities.md):
...
### 3.2.4. Data Engineering blogs of companies:
...
### 3.2.5. Data Engineering Whitepapers:
...
### 3.3.2. Great [list of 20+ newsletters](newsletters.md)
